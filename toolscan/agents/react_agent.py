...
class ReactAgent(
    BaseAgent
):  # the agent should receive goal, state and action, then return the next state
    def __init__(
        self,
        llm_model,
        memory_size=100,
            ...
            for act in action_temp:
                if (
                    ...
                    while idx + 1 < len(action_temp):
                        ...
                        idx += 1
                if (
                    act.split(":")[0].lower().endswith("with action input")
    ...
    def run(self, init_prompt_dict=None):
        ...
        while not flag:
            ...
            if response.startswith("Action"):
                ...
                self.memory.append(("Think", response))
    ...
    def from_config(cls, llm_model, config):
        ...
        return cls(
            ...
            check_inventory,
            use_parser,
            max_think_iters=max_think_iters,
        )
